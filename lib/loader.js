...
module.exports = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(content) {
    ...
    var isProduction, query, pathname, emitFile, config, callback, url, urlExt, addDependency, addContextDependency, watchFiles, watchFolders, vulcanizeContent, jsFileName, crisp, es6, babelCode, uglify, transformJS, htmlCode, emitFiles, processContent, finalUrl, webpackModuleResult, _callback, resolve, _reject, result;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            babelCode = function babelCode(content) {
              return es6 ? babel.transform(content, { compact: false, presets: ['es2015'] }).code : content;
            };
